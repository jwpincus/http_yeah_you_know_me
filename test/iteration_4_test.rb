...
class TestHelloWorld < Minitest::Test
 ...
 "Accept-Language: en-US,en;q=0.8"]
  ...
  def test_game
    ...
    test_server.number_to_guess = 3
    assert_equal "No guesses made yet", Server.new.game("GET", "")
    assert_equal "1 guesses have been made and the most recent guess (5) was too high", test_server.game("GET", "guess=5")
  end
end